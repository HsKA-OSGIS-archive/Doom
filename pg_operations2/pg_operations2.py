...
def pg_select2(d_conn, table_name, string_fields_to_select, cond_where='', list_val_cond_where=[]):
    ...
    Return: 
        ...
        * a list, of a list, of a list of dictionaries. Each dictionary is a selected row
          to get the fist dictionary: lista[0][0][0]
          to get the seconf dictionary: lista[0][0][1]
          ... and so on
    ...
    Example of use:
        ...
        print ''
        print 'First row lista[0][0][0], wich is a dictionary'
        #gets the first row, wich is a dictionary
        print lista[0][0][0]
        
        print ''
        print 'Second row lista[0][0][1], wich is a dictionary'
